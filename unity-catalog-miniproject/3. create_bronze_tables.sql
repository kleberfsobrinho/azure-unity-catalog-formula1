...
USING json
OPTIONS (path 'abfss://bronze@databrickscourseucextks7.dfs.core.windows.net/drivers.json')
...
USING json
OPTIONS (path "abfss://bronze@databrickscourseucextks7.dfs.core.windows.net/results.json");
